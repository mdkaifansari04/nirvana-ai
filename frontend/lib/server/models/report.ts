...
export type ReportDocument = InferSchemaType<typeof nirwanaReportSchema>;

export const Report =
  (mongoose.models.NirwanaReport as Model<ReportDocument>) ||
  mongoose.model<ReportDocument>("NirwanaReport", nirwanaReportSchema);
