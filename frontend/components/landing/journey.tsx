        ...
        <div className="grid md:grid-cols-2 gap-12 mx-auto">
          ...
          <div className="p-6 rounded-xl shadow-md">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-muted px-4 py-3 rounded-lg w-fit">"That's understandable. Let's break down what's making you anxious and explore some techniques to help you feel more prepared."</div>
            </div>
          </div>
