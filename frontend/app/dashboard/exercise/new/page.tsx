...
export default function NewExercisePage() {
   ...
   const handleSessionSetup = async (data: { sessionGoal: string; moodRating: number; primaryEmotion: string }) => {
      ...
      setIsLoading(true);
      try {
         const generatedExercise = await ExerciseService.generateCoreExercise(data.sessionGoal);
         setExerciseContent(generatedExercise);
   ...
   const handleMicroExerciseComplete = async (data: {
   ...
   const renderCurrentStage = () => {
      ...
      switch (currentStage) {
         ...
         case ExerciseStage.CORE_EXERCISE:
            return exerciseContent ? <CoreExercise exerciseContent={exerciseContent} sessionGoal={sessionGoal} onStartExercise={handleStartExercise} /> : null;

         case ExerciseStage.MICRO_EXERCISE:
            return exerciseContent ? (
               <MicroExercise exerciseContent={exerciseContent} sessionGoal={sessionGoal} initialMoodRating={moodRating} initialEmotion={primaryEmotion} onComplete={handleMicroExerciseComplete} />
            ) : null;
