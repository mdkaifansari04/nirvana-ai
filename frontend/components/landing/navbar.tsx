            ...
            <div className="hidden lg:flex items-center gap-4">
               {user ? (
                  <>
                     ...
                     <button type="button" onClick={handleLogout} className="bg-amber-700 hover:bg-amber-600 text-white font-semibold text-sm px-4 py-2 rounded-lg transition shadow-sm">
                        Logout
                     </button>
                  </>
               ) : (
