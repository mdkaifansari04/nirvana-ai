  ...
  const saveJournal = () => {
    ...
    mutate(
      ...
      },
      {
        onSuccess: () => {
          toast({
            title: "Chat response saved successfully",
            description: "Your interaction with the chatbot has been recorded. You can review it anytime in your chat history.",
          });
        },
        onError: (error: Error) => {
          toast({
