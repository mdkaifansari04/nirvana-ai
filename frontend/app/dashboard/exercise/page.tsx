...
import { getActivityData } from '@/lib/demo-exercise-data';
import { ExerciseService } from '@/services/exercise.service';
import type { ExerciseSummary, MicroExercise } from '@/types';
...
export default function ExerciseDashboardPage() {
   const [exercises, setExercises] = useState<MicroExercise[]>([]);
   ...
   useEffect(() => {
      const fetchExercises = async () => {
         try {
            const data = await ExerciseService.getUserExercises('user_123');
            setExercises(data);
