        ...
        <div className="hidden lg:flex items-center gap-4">
          {user ? (
            <>
              ...
              <button type="button" onClick={handleLogout} className="bg-secondary/30 cursor-pointer hover:bg-secondary-300 text-white font-semibold text-sm px-4 py-2 rounded-lg transition shadow-sm">
                Logout
              </button>
            </>
          ) : (
                  ...
                  <div className="flex flex-col items-center gap-4">
                    {user ? (
                      ...
                      <>
                        ...
                        <Link href="/sign-up" className="bg-secondary/30 hover:bg-secondary-300 text-white font-semibold text-lg px-4 py-2 rounded-lg transition shadow-sm w-full text-center" onClick={() => setOpen(false)}>
                          Sign Up
                        </Link>
                      </>
                    )}
